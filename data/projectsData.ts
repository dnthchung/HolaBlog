...
const projectsData = [
  ...
  },
  {
    ...
    techStack: ['ReactJS v18', 'TypeScript', 'Ant Design', 'Tailwind', 'TanStack Query', 'Zustand'],
  ...
  },
  {
    ...
    techStack: ['ReactJS v18', 'Shadcn UI', 'TanStack Router/Query', 'Leaflet', 'Zod', 'Flutter', 'Firebase'],
  ...
  },
  {
    ...
    techStack: ['ReactJS v18', 'ExpressJS v4', 'Styled Components', 'Ant Design', 'Redux Toolkit'],
  ...
  },
  {
    ...
    techStack: ['Vite', 'ReactJS v18 (JavaScript)', 'ExpressJS v4', 'MongoDB', 'Redux Toolkit', 'Shadcn UI'],
  ...
  },
  {
    ...
    techStack: ['Java JDBC', 'Servlet', 'SQL Server', 'Tomcat 10', 'Bootstrap', 'JSP'],
